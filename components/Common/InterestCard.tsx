...
export const InterestCard = (props: InterestCardProps) => {
  ...
  return <View className='flex p-3 rounded-2xl' style={{ backgroundColor: Colors.dark.darkText, borderColor: Colors.dark['primary-material-1'], borderWidth: 1 }}>
    ...
    <View className='flex flex-row items-center'>
      ...
      <View className='flex flex-row items-center'>
        ...
        <View className='flex mr-3'>
          <Label type={FontTypes.FP} label={postedBy.name} classNames='mb-1' numberOfLines={1} />
    ...
    <View className='flex flex-row my-4'>
      ...
      <Label label={subtitle} type={FontTypes.FLabel} color={Colors.dark['grey-shade-3']} classNames='w-100' numberOfLines={2} containerStyles={{ flexShrink: 1 }} />
    </View>
    ...
    <View className='flex flex-row items-center justify-between'>
      <View className='flex flex-row items-center'>
        ...
        <View className='flex-row items-center ml-2'>
          ...
          <Label label={`|  ${interestedCount}`} type={FontTypes.FLabel} classNames='ml-1' />
        </View>
      </View>
