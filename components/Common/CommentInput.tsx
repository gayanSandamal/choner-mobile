...
export const CommentInput = React.forwardRef((props: CommentInputProps, inputRef: React.LegacyRef<TextInput> | undefined) => {
    return (
        <View style={styles.commentUser}>
          ...
          <View className="pb-3" />
          <TextInput multiline ref={inputRef} textAlignVertical="top" value={props.text} editable={!props.isDisabled} maxLength={1000} style={styles.commnetInput} onChangeText={props.onTextChange} placeholder='Your thoughts...' placeholderTextColor={Colors.dark['grey-shade-3']} />
