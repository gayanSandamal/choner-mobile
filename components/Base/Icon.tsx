...
const getIcon = (props: { color: string, name: string }) => {
    ...
    const iconMap = {
        ...
        [IconNames.chevronMiniLeft]: <Icons.IconChevronMiniLeft fill={color} />,
        ...
        [IconNames.plus]: <Icons.IconPlus fill={color} />,
        [IconNames.bicepsFilled]: <Icons.IconBicepsFilled fill={color} />,
        [IconNames.xp]: <Icons.IconXP fill={color} />,
        [IconNames.reward]: <Icons.IconReward fill={color} />,
        [IconNames.planet]: <Icons.IconPlanet fill={color} />,
        [IconNames.badge]: <Icons.IconBadge fill={color} />,
        [IconNames.virtual]: <Icons.IconVirtual fill={color} />,
        [IconNames.onLocation]: <Icons.IconOnLocation fill={color} />,
        ...
        [IconNames.circleCheck]: <Icons.IconCircleCheck fill={color} />,
        [IconNames.survey]: <Icons.IconSurvey fill={color} />,
