...
export const Btn = (props: BtnProps) => {
  ...
  const buttonCore = () =>
    <View className={`flex flex-row items-center justify-center shadow-sm ${block && 'w-full'} ${classNames}`} style={[btnStyles, props.style]}>
      ...
      <Label {...{ label, color }} type={props.fontType} containerStyles={{ ...(!props.fontType && {fontWeight: textMode ? 400 : 600}), marginLeft: icon ? 12 : 0, marginRight: icon ? 4 : 0, ...(props.fontStyle && {borderBottomWidth: 0.7, borderBottomColor: color}) }} />
    </View>
  return (
