...
export default function InitialScreen(props: SignUpScreenProps) {
  ...
  return (
    <ContentSection cardMode={false} containerStyles={{ maxWidth: 353 }}>
      ...
      <Btn wrapperClasses='mt-6' onPress={onPressSignIn} icon={IconNames.register} size={InputSizes.lg} block outlined color={Colors.dark['primary-shade-1']} label="SIGN UP"></Btn>
      ...
      <View className='flex items-center'>
        <Btn wrapperClasses='text-center' onPress={onPressSignIn} size={InputSizes.sm} textMode link={'/'} color={Colors.dark.link} label="Terms of Service and Privacy Policy"></Btn>
      </View>
    </ContentSection>)
}